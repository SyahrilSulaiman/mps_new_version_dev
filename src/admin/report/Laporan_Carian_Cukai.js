        ...
        <div>
            <table className="table-auto w-full shadow-lg bg-white">
                ...
                <tr>
                    ...
                    <th className=" bg-blue-100 border text-sm text-center px-4 py-2">Nama</th>
                    <th className=" bg-blue-100 border text-sm text-center px-4 py-2">No Tel</th>
                    ...
                    <th className=" bg-blue-100 border text-sm text-center px-4 py-2">No Invois</th>
                    <th className=" bg-blue-100 border text-sm text-center px-4 py-2">No Resit</th>
                    <th className=" bg-blue-100 border text-sm text-center px-4 py-2" onClick={handleSort}>Tarikh Pembayaran&nbsp;
                        {
