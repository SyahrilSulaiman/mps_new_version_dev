                    ...
                    <div className=" w-full xl:pt-24 lg:pt-24 md:pt-16 sm:pt-16 xs:pt-16">
                        <div className="flex flex-wrap">
                            <Pane background="#2c3e50" className="xl:mx-4 xl:rounded-md" width="100%">
                                <Topbar title="Bil / Maklumat Bil" leftButtonIcon={ArrowLeftIcon} onClickLeftButton={() => window.history.back()} />
                            </Pane>
                                ...
                                <div className="flex-auto p-4 mt-6">
                                    ...
                                    >
                                        <Pane>
                                            ...
                                            <Heading size={200}>{bills.bill.data[0][0].STATUS === "PENDING PAYMENT" ? (<span className="uppercase font-medium text-xs text-red-400">Tertunggak</span>) : (<span className="uppercase font-medium text-xs text-green-400">Telah Dibayar</span>)}</Heading>
                                        </Pane>
                                    </Card>
                                    <Card
